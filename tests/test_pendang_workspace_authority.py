...
def test_workspace_owner_manager_gets_crm_owner_routes_but_not_global_admin(pendang_team):
    ...
    allowed = (
        ...
        ("POST", "/crm/leads/1/proposals/1/submit-review"),
        ("POST", "/crm/leads/1/proposals/1/approve"),
        ("POST", "/crm/leads/1/proposals/1/send"),
        ("POST", "/crm/leads/1/proposals/1/decision"),
    ...
    denied = (
        ...
        ("GET", "/history"),
        # Financial data is the literal global Owner only — even Pendang's
        # workspace-owner authority does not reach it.
        ("GET", "/crm/engagements/1/billing"),
        ("POST", "/crm/engagements/1/billing/arrangements"),
        ("POST", "/crm/engagements/1/billing/arrangements/1/cancel"),
        ("POST", "/crm/engagements/1/billing/invoices"),
        ("POST", "/crm/engagements/1/billing/invoices/1/status"),
        ("POST", "/crm/engagements/1/billing/invoices/1/payments"),
        ("POST", "/crm/engagements/1/billing/payments/1/void"),
        ("POST", "/crm/engagements/1/billing/costs"),
        ("POST", "/crm/engagements/1/billing/costs/1/delete"),
    )
