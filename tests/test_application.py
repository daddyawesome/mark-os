...
EXPECTED_ROUTES = [
    ...
    ("POST", "/logout", "logout"),
    ("GET", "/account/sessions", "account_sessions_page"),
    ("POST", "/account/sessions/revoke-others", "account_sessions_revoke_others"),
    ("GET", "/notifications", "notification_center"),
    ("GET", "/insights", "insights_dashboard"),
    ("GET", "/service-worker.js", "service_worker"),
    ("GET", "/account/export", "export_page"),
    ("GET", "/account/export/download", "export_download"),
    ...
    ("GET", "/history", "history"),
    ("GET", "/life-os", "life_os"),
    ("GET", "/memories", "memory_center"),
    ("POST", "/memories", "create_manual_memory"),
    ("GET", "/memories/{memory_id}/edit", "edit_memory_page"),
    ("POST", "/memories/{memory_id}/edit", "update_manual_memory"),
    ("POST", "/memories/{memory_id}/archive", "archive_manual_memory"),
    ("POST", "/memories/candidates/{candidate_id}/accept", "accept_candidate"),
    ("POST", "/memories/candidates/{candidate_id}/reject", "reject_candidate"),
    ("POST", "/memories/candidates/{candidate_id}/archive", "archive_candidate"),
    ("GET", "/chat", "chat_home"),
    ("POST", "/chat/new", "start_chat_session"),
    ("GET", "/chat/{session_id}", "chat_thread"),
    ("POST", "/chat/{session_id}/messages", "post_chat_message"),
    ...
    ("GET", "/settings/users/", "users_page"),
    ("GET", "/settings/users/security-audit/events", "security_audit_page"),
