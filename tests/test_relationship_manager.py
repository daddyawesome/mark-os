...
def test_relationship_manager_access_surface_is_narrow(
    ...
    allowed = (
        ...
        ("GET", "/crm/effort"),
        ("GET", "/crm/leads/7/qualification/edit"),
        ("POST", "/crm/leads/7/qualification/edit"),
        ("GET", "/crm/leads/7/proposals"),
        ("GET", "/crm/leads/7/proposals/1"),
        ("GET", "/crm/clients/1"),
    ...
    denied = (
        ...
        ("POST", "/crm/leads/7/qualification/decide"),
        ("POST", "/crm/leads/7/proposals"),
        ("POST", "/crm/leads/7/proposals/1/edit"),
        ("POST", "/crm/leads/7/proposals/1/submit-review"),
        ("POST", "/crm/leads/7/proposals/1/approve"),
        ("POST", "/crm/leads/7/proposals/1/send"),
        ("POST", "/crm/leads/7/proposals/1/decision"),
        ("POST", "/crm/leads/7/onboard"),
        ("GET", "/crm/clients"),
